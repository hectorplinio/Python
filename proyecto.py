...
class Profesor(Persona):
    ...
    def alta_profesor(self):
        ...
        frase=self.identificador[-1]+";"+self.nombre[-1]+";"+self.telefono[-1]+";"+self.departamento[-1]+";Profesor"
        profes.write(frase+"\n")
    ...
    def borrar_profesor(self):
        ...
        for i in self.nombre:
            if i == bor:
                ...
                frase=self.identificador[contador]+";"+self.nombre[contador]+";"+self.telefono[contador]+";"+self.departamento[contador]+";Profesor"
                archivo.write(frase+"\n")
                contador+=1
        archivo.close()
    ...
    def actualizar_profesores(self):
        ...
        for i in range(len(self.nombre)):
            frase=self.identificador[i]+";"+self.nombre[i]+";"+self.telefono[i]+";"+self.departamento[i]+";Profesor"
            archivo.write(frase+"\n")
        archivo.close()
...
class Alumno(Persona):
    ...
    def alta_alumno(self):
        ...
        for lineas in archivo:
            ...
            lineas=lineas.split(";")
            if lineas[0] == cod:
                print("Este alumno ya esta en la lista, cambie el codigo.")
                cod=input("Dime el codigo del alumno: ")
        self.identificador.append(cod)
        Persona.alta(self)
        self.curso.append(input("Dime el curso al que pertenece: "))
        frase=self.identificador[-1]+";"+self.nombre[-1]+";"+self.telefono[-1]+";"+self.curso[-1]+";Alumno"
        archivo.write(frase+"\n")
    ...
    def borrar_alumno(self):
        ...
        for i in self.nombre:
            if i == bor:
                ...
                frase=self.identificador[contador]+";"+self.nombre[contador]+";"+self.telefono[contador]+";"+self.curso[contador]+";Alumno"
                archivo.write(frase+"\n")
                contador+=1
        archivo.close()
    ...
    def actualizar_alumnos(self):
        ...
        for i in range(len(self.nombre)):
            frase=self.identificador[i]+";"+self.nombre[i]+";"+self.telefono[i]+";"+self.curso[i]+";Alumno"
            archivo.write(frase+"\n")
        archivo.close()
...
class Asignatura(Profesor):
    ...
    def alta_asignatura(self):
        ...
        frase=self.idasignatura[-1]+";"+self.nombre[-1]+";"+self.identificador[-1]+";"+self.curso[-1]+self.horas_semanales[-1]+";Asignatura"
        archivo.write(frase+"\n")
    ...
    def borrar_asignatura(self):
        ...
        for i in self.nombre:
            if i == bor:
                ...
                frase=self.idasignatura[contador]+";"+self.nombre[contador]+";"+self.identificador[contador]+";"+self.curso[contador]+self.horas_semanales[contador]+";Asignatura"
                archivo.write(frase+"\n")
                contador+=1
        archivo.close()
